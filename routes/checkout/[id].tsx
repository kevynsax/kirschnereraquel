...
import { Field } from '../../islands/utils/Field.tsx';
import { useEffect, useState, useCallback } from "preact/hooks";
import { TextField } from '../../islands/utils/TextField.tsx';
        ...
        <div className="checkout">
            ...
            <div className="warning">
                ...
                <span>
                    ...
                    falar com a gente pelo WhatsApp: <a target="_blank" href={linkWhatsapp}>(61) 9 8589-1092</a>
                </span>
            </div>

            <div className="body">
                <GiftForm id={props.data.product.id} />
